...
const handleUpdateProfile = async () => {
  ...
  try {
    ...
    await authStore.fetchProfile()
    successMessage.value = 'Your profile details have been updated successfully!'
    password.value = ''
        ...
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
          <div class="card-header bg-dark-slate text-white p-4">
            <h5 class="fw-bold mb-1 d-flex align-items-center">
              <i class="bi bi-person-lines-fill me-2 text-emerald"></i>My Trekker Profile
            </h5>
            <p class="text-white-50 small mb-0">Update your account information and login credentials</p>
          </div>
          ...
          <div class="card-body p-4">
            <form @submit.prevent="handleUpdateProfile">
              ...
              <h6 class="fw-bold text-dark mb-3">Change Password (Optional)</h6>
